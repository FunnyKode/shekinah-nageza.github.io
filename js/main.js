...
const translations = {
  en: {
    ...
    'about.p1':    'I am a passionate software engineer and AI researcher, with a strong focus on web technologies. I am currently training in networking and cybersecurity.',
    'about.p2':    'My journey in software development started with curiosity and has grown into a professional craft. I enjoy building robust, user-focused solutions while deepening my expertise in intelligent systems.',
    'about.p3':    'I keep learning every day through practical projects in artificial intelligence, networks, and cyber defense.',
    'about.image.placeholder': 'Image space',
  ...
  fr: {
    ...
    'about.p1':    'Je suis un ingénieur logiciel passionné et aussi chercheur en intelligence artificielle, spécialisé dans les technologies web. Je suis actuellement en formation dans le domaine des réseaux et de la cybersécurité.',
    'about.p2':    'Mon parcours dans le développement logiciel a commencé par la curiosité et est devenu un véritable métier. J\'aime construire des solutions robustes et centrées sur l\'utilisateur tout en approfondissant mon expertise des systèmes intelligents.',
    'about.p3':    'J\'apprends chaque jour à travers des projets pratiques en intelligence artificielle, en réseaux et en cyberdéfense.',
    'about.image.placeholder': 'Espace image',
